...
<link rel="stylesheet" type="text/css" href="css/camion_autre.css">
...
<body style="background-color: rgb(27,33,54);min-width: 320px; ">
  ...
  <div class="container-fluid containerp" style="margin-bottom: 100px;" >
    <div class="row containerp1" style="position: relative; top: 65px;  background-color:rgb(32,41,64);border-radius: 15px 15px 0px 0px;">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 " style=" min-width: 320px; background-color: rgb(32,41,64);  border-radius: 15px 15px 0px 0px;  border-bottom: double white 1px; color: white;">
        <div class=" col-xs-12 col-sm-4 col-md-5 col-lg-6" style=" padding-top: 10px; color: white;"> <h4 class="col-xs-6 col-sm-12 col-md-12 col-lg-12">Détail Flotte  </h4><h4 class="col-xs-6 col-sm-12 col-md-12 col-lg-12">flotte Renault port 1</h4></div>
      ...
      <div class="scrollbar scrollbar-primary" style=" border: inset  1px; background-color:rgb(32,41,64); color:rgb(6,6,6);max-height: 500px">
        <table class="table table-striped   custab" style="min-width: 1000px;background-color:transparent; color: rgb(143,149,163);">
          <thead>
            <tr>
              <th>flotte</th>
              <th>Nom Unité</th>
            ...
            <tr>
                ...
                <td >
                  <a class='btn btn-info btn-xs col-xs-6 col-sm-6' style="display: inline-block;margin-top: 3px;" href="c-transfert.php?id=seb 33"><span class="glyphicon glyphicon-edit"></span> Transfert</a> 
                  <a class='btn btn-warning btn-xs col-xs-6 col-sm-6' style="display: inline-block;margin-top: 3px;" href="c-panne.php?etat=bonne"><span class="glyphicon glyphicon-edit"></span> Panne</a>
                  <a  class="btn btn-danger btn-xs col-xs-6 col-sm-6" style="display: inline-block;margin-top: 3px;" href="c-accident.php?etat=bonne"><span class="glyphicon glyphicon-remove"></span> Accidenté</button>
                  <a class="btn btn-default btn-xs col-xs-6 col-sm-6" style="display: inline-block;margin-top: 3px;" href="c-decroche.php?benne=r-50"  ><span class="glyphicon glyphicon-remove"></span>Décrocher</a>
                </td>
            </tr>
            <tr>
                <td>Unite 2</td>
                ...
                <td>Accidenté</td>
                <td>12/08/2019 18:05</td>
                
                <td ><a class='btn btn-success btn-xs' href="c-accident.php?etat=accident"><span class="glyphicon glyphicon-edit"></span> Sortie Accident</a></td>
            </tr>
            <tr>
                <td>Unite 3</td>
                <td>News</td>
                ...
                <td>News</td>
                <td>En panne   </td>
                <td>14/08/2019 13:28</td>
                
                <td ><a class='btn btn-success btn-xs' href="c-panne.php?etat=panne"><span class="glyphicon glyphicon-edit"></span> Dépanne </a></td>
            </tr>
            <?php for ($i=0; $i <50 ; $i++) { 
            ?>
            <tr>
                <td>Unite <?php echo $i+4; ?></td>
                <td>Serrage des goujons de roues et contrôle pression d'air</td>
                <td>Serrage des goujons de roues et contrôle pression d'air</td>
                <td>Serrage des goujons de roues et contrôle pression d'air</td>
                <td>Serrage des goujons de roues et contrôle pression d'air</td>
                <td>Serrage des goujons de roues et contrôle pression d'air</td>
                ...
                <td ><a class='btn btn-info btn-xs' href="#"><span class="glyphicon glyphicon-edit"></span> Transfert</a> <a class='btn btn-warning btn-xs' href="c-panne.php?etat=bonne"><span class="glyphicon glyphicon-edit"></span> Panne</a> <a href="#" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span> Accidenté</a></td>
            </tr>
         <?php  } ?>
        </table>
      </div>
   ...
   <div  class="menu-bas navbar-fixed-bottom" style=" border-top: ridge black 1px; height: 30px; background-color: rgb(32,41,64); margin-top: 0;padding-top: 0;">
    <div class="container menu-basa" style="margin: 0;padding: 0; text-align: center;">
        ...
        <ul class="nav  menubas" style="">
           <li class="col-xs-3 col-sm-2 col-md-2" style="margin: 0;padding: 0;"><a href="" class="etat">
