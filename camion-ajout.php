...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/camion-ajout.css">
    ...
    <div class="col-md-12 containerp2" style="">
      <div class=" containerp3" style="">
        <div class="row card-header" style="height: 60px;border-bottom: ridge 1px; padding-left: 20px;padding-top: 15px;">
          <div class="card-title" style="font-size: 20px">Entré Les Informations</div>
        </div>
        <div class="card-body" style="margin-top: 15px">
          <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="form-group has-primary">
                <label for="Idcmid">Identifiant  Camion *</label>
                <input style="background-color: rgb(27,33,54);" type="text" id="Idcmid" placeholder="Champ Obligatoire" class="form-control">
              </div>
              <div class="form-group has-primary">
                <label for="marquecmid">Marque  Camion *</label>
                <input style="background-color: rgb(27,33,54);" type="text" id="marquecmid" placeholder="Champ Obligatoire" class="form-control">
              </div>
              <div class="form-group has-primary">
                <label for="marquecmid">SERIE *</label>
                <input style="background-color: rgb(27,33,54);" type="text" id="marquecmid" placeholder="Champ Obligatoire" class="form-control">
              </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              ...
              <div class="form-group has-primary">
                <label for="marquecmid">Immatriculation </label>
                <input style="background-color: rgb(27,33,54);" type="text" id="marquecmid" placeholder="Ex: IT-xxxx" class="form-control">
              </div>
              <div class="form-group form-group-default">
                <label>ZONE MOBILE</label>
                <select style="background-color: rgb(27,33,54);" class="form-control" id="formGroupDefaultSelect">
