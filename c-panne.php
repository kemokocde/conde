...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/c-panne.css">
  ...
  <div  class="row menuinfo" style="height: 60px; background-color: transparent; margin-top: 0;padding-top: 0;">
    ...
    <div class="row containerp2" style="">
        ...
        <div class="card-header" style="height: 60px;border-bottom: ridge 1px; padding-left: 20px;padding-top: 15px; ">
          <div class="card-title" style="font-size: 20px">Fiche de panne</div>
        </div>
        <div class="card-body" style="margin-top: 15px; ">
          <div class="" style="font-family: Arial Black;">
            <div class="col-sm-6 col-md-6 col-lg-6" >
              <div class="form-group has-primary">
                <div class="text1" >Identifiant  Camion : <samp>Unite 9999</samp></div>
               
              </div>
              <div class="form-group has-primary">
                <div class="text1" >Marque  Camion : <samp>Renault</samp></div>
                
              </div>
              <div class="form-group has-primary">
                <div class="text1" >SERIE : <samp>kerex 1500</samp></div>
                
              </div>
              <div class="form-group form-group-default">
                <div class="text1">Model :<samp> 6x2</samp></div>
              </div>

              <div class="form-group form-group-default bennea ">
                <div class="text1">Etat actuel : 
                  <samp class="benn text-success <?php if ($etat != 'panne') { echo '';}else{ echo 'masque';}?>" style="color: green" >Bonne</samp>
                  <samp class="benn text-danger <?php if ($etat == 'panne') { echo '';}else{ echo 'masque';}?>" style="color: red" >En Panne</samp>
                </div>
              </div>
              <div class="form-group form-group-default <?php if ($etat != 'panne') { echo 'affiche';}else{ echo 'masque';}?>">
                <label id="tbenne" class="text1">Lieu D’accident </label>
              ...
              <div class="form-group form-group-default <?php if ($etat == 'panne') { echo 'affiche';}else{ echo 'masque';}?>">
                <label id="tbenne" class="text1">Lieux de dépannage  </label>
                <select style="background-color: rgb(27,33,54);" class="form-control" id="tbenne">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6">
              <div class="form-group has-primary ">
                <label for="filter-date" class="text1 <?php if ($etat != 'panne') { echo 'affiche';}else{ echo 'masque';}?>">Date et Heures  D’panne *</label>
                <label for="filter-date" class="text1 <?php if ($etat == 'panne') { echo 'affiche';}else{ echo 'masque';}?>">Date et heures de dépannage *</label>
                <input style="background-color: rgb(27,33,54);" class="form-control" type="text" name="filter-date" id="filter-date" autocomplete="off" />
              </div>
              <div class="form-group form-group-default <?php if ($etat != 'panne') { echo '';}else{ echo 'masque';}?>">
          ...
          <div class="text1">Type de panne</div>
          <div class="checkbox primary"><input type="checkbox" id="checkbox-1"><label class="text2" for="checkbox-1">Electrique</label></div>
          <!-- /.checkbox -->
          <div class="checkbox primary"><input type="checkbox" id="checkbox-2"><label class="text2" for="checkbox-2">Mécanique</label></div>
          <!-- /.checkbox -->
          <div class="checkbox primary"><input type="checkbox" id="checkbox-3"><label class="text2" for="checkbox-3">Pneumatique</label></div>
          <!-- /.checkbox -->
          <div class="checkbox primary"><input type="checkbox" id="checkbox-4"><label class="text2" for="checkbox-4">Soudure</label></div>
          <!-- /.checkbox -->
          <div class="checkbox primary"><input type="checkbox" id="checkbox-6"><label class="text2" for="checkbox-6">Tôlerie-Peinture</label></div>
          <!-- /.checkbox -->
         <div class="text1">Etat</div>
          <ul class="list-inline">
            <li>
              <div class="radio success"><input type="radio" checked name="radio-2" id="radio-10"><label class="text2" for="radio-10">Disponible</label></div>
              <!-- /.radio -->
            </li>
            <li>
              <div class="radio warning"><input type="radio" name="radio-2" id="radio-11"><label class="text2" for="radio-11">Arrêt</label></div>
              <!-- /.radio -->
            </li>
            <li>
              <div class="radio danger"><input type="radio" name="radio-2" id="radio-12"><label class="text2" for="radio-12">Accidenté</label></div>
              <!-- /.radio -->
            </li>
          </ul>
          <!-- /.list-inline -->
...
<script>
  ...
  var SweetAlert2Demo = function() {
    ...
    <?php if (isset( $_GET['etat']) and  $_GET['etat']!= "panne" ) { ?>     
        ...
        setTimeout(mafonction, 2000); 
          ...
          swal({
            icon: "warning",
            text: "Confirmer vous que l’unité xxx est en panne",
            type: 'warning',
            buttons:{
              confirm: {
                text : 'oui',
            ...
            if (Delete) {
              <?php if ($valeur == "vraix") { ?> 
                setTimeout( document.location.href="c-panne.php?etat=panne", 2000); 
        ...
        setTimeout(mafonction, 2000); 
          ...
          swal({
            ...
            if (Delete) {
              ...
              }); setTimeout( document.location.href="c-panne.php?etat=bonne", 3000);
                $('.containerl').replaceWith('<div class="container p2" ></div>');
                $('.containerp').css('opacity','1');
